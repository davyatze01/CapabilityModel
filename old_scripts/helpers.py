...
class PipelineConfig:
    ...
    bus_cache_pkl: str = os.path.join("outputs", "r5_fast_routes.sqlite")       # Where to find the pickle table with the cached results
...
class BusRoutingStageResult:
    ...
    routing_pkl: str             # Where the cached pickle with the routing results is saved
